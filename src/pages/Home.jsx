        ...
        <div>
            <div className='max-w-maxContent relative mx-auto flex flex-col w-11/12 items-center text-white justify-between'>
                ...
                <div className='text-center text-4xl font-semibold mt-7'>
                    Empower Your Future with < HighlightText text={"Codin Skills"} />
                </div>
                ...
                <div>
                    <CodeBlocks
                        ...
                        backgroundGradiant={<div className="codeblock2 absolute"></div>}
                    />
                </div>
                <ExploreMore />
            </div>
                ...
                <div className='homepage_bg h-[310px]'>
                    <div className='w-11/12 max-w-maxContent flex flex-col items-center gap-5 mx-auto'>
                        ...
                        <div className='flex flex-row gap-7 text-white'>
                            <div> <CTAButton active={true} linkto={"/signup"}><div className='flex items-center gap-3'>Explore Full Catalog  <FaArrowRight /></div></CTAButton></div>
                ...
                <div className='mx-auto w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-7'>
                    <div className='flex flex-row gap-5 mb-10 mt-[95px]'>
                        <div className='text-4xl font-semibold w-[45%]'>
                            Ge the Skills you need for a <HighlightText text={"Job that is in demand"} />
                        </div>
                        <div className='flex flex-col gap-3 w-[40%] items-start'>
                            <div>  The modern StudyNotion is the dictates its own terms. Today, to
            ...
            <div className='w-11/12 mx-auto max-w-maxContent flex flex-col items-center justify-between gap-8 first-letter bg-richblack-900 text-white '>
                <InstructorSection />
                <h2 className='font-semibold text-4xl text-center'>Review from other learners</h2>
            </div>
        </div>
    )
}
